/* Formatted on 2020/04/21 오후 6:48:41 (QP5 v5.360) */
--4강_join.sql
--20-04-21 화
...
SELECT s.STUDNO    학번,
  ...
  --
  select l.city, d.department_name, e.job_id, e.job_id, e.salary
  ...
  select l.city, d.department_name, e.job_id, sum(e.salaty) 급여합계, count(*) 인원수
